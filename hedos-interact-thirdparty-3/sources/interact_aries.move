module delta_hedging_interact::interact_aries {
    use std::signer;
    use std::string;
    ...
    public fun get_borrow_statistic<Coin0>(): BorrowStatistic acquires BorrowStatistics {
        let bs_ref = borrow_global<BorrowStatistics<Coin0>>(@delta_hedging_interact);
        bs_ref.data
    }
    ...
    public entry fun repay<Coin1>(
        ...
        let _total_coin1_loaning = total_loaning<Coin1>(account);
